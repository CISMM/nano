 ...
 **************************************************************************/
  ...
  spm_report_latest_scanrate (stm_nmeters_per_second);	// report nM/second
 ...
 ***************************************************************************/
  ...
  change_scan_rate(stm_nmeters_per_second);
  return;
}
