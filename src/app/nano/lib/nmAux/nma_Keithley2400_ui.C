...
void nma_Keithley2400_ui::handle_connect_and_init(vrpn_int32 /*_newvalue*/, void *_userdata) {
...
void nma_Keithley2400_ui::handle_int_param_change(vrpn_int32 /*_newvalue*/, void *_userdata) {
	nma_Keithley2400_ui * me = (nma_Keithley2400_ui *)_userdata;
...
void nma_Keithley2400_ui::handle_stepsize_change(vrpn_float64 /*_newvalue*/, void * _userdata) {
    nma_Keithley2400_ui * me = (nma_Keithley2400_ui *)_userdata;

    //printf("sweep_stepsize %g\n", (float)me->sweep_stepsize);
	...
	int new_num_points = (int)((me->keithley2400->d_sweep_stop - me->keithley2400->d_sweep_start)/me->sweep_stepsize + 1);
	// The truncation above means the stepsize might get bigger
	// In the example, 3 steps means a stepsize of 1. 
	me->sweep_stepsize = ((me->keithley2400->d_sweep_stop - me->keithley2400->d_sweep_start)/(new_num_points -1));
...
// of points in a sweep. So we link stepsize and numpoints -
// one sets the other.  We _only_ send numpoints to the Keithley.
void nma_Keithley2400_ui::handle_numpoints_change(vrpn_int32 /*_newvalue*/, void *_userdata) {
	nma_Keithley2400_ui * me = (nma_Keithley2400_ui *)_userdata;

	//printf("sweep_numpoints %d\n", (int)me->sweep_numpoints);
...
void nma_Keithley2400_ui::handle_startstop_change(vrpn_float64 /*_newvalue*/, void *_userdata) {
	nma_Keithley2400_ui * me = (nma_Keithley2400_ui *)_userdata;
...
void nma_Keithley2400_ui::handle_take_iv_curves(vrpn_int32 /*_newvalue*/, void *_userdata) {
	nma_Keithley2400_ui * me = (nma_Keithley2400_ui *)_userdata;

	//me->set_voltage_vector();
...
void nma_Keithley2400_ui::handle_take_repeat_iv_curves(vrpn_int32 /*_newvalue*/, void *_userdata) {
	nma_Keithley2400_ui * me = (nma_Keithley2400_ui *)_userdata;
...
{
	connect_and_init.addCallback(
		handle_connect_and_init, this);
	source = keithley2400->d_source;
	source.addCallback(
		handle_int_param_change, this);
	compliance = keithley2400->d_compliance;
	compliance.addCallback(
		handle_int_param_change, this);
	compliance_val = keithley2400->d_compliance_val;
	compliance_val.addCallback(
		handle_float_param_change, this);
	num_power_line_cycles = keithley2400->d_num_power_line_cycles;
	num_power_line_cycles.addCallback(
		handle_float_param_change, this);
	sweep = keithley2400->d_sweep;
	sweep.addCallback(
		handle_int_param_change, this);
	sweep_start = keithley2400->d_sweep_start;
	sweep_start.addCallback(
		handle_startstop_change, this);
	sweep_stop = keithley2400->d_sweep_stop;
	sweep_stop.addCallback(
		handle_startstop_change, this);
	sweep_stepsize.addCallback(
		handle_stepsize_change, this);
	sweep_numpoints.addCallback(
		handle_numpoints_change, this);
	...
	sweep_delay.addCallback(
		handle_float_param_change, this);
	num_sweeps = 1;
	display_enable = keithley2400->d_display_enable;
	display_enable.addCallback(
		handle_int_param_change, this);
	take_iv_curves.addCallback(
...
void nma_Keithley2400_ui::receive_ResultData(void *_userdata, 
