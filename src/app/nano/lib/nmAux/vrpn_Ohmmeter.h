...
#ifdef _WIN32
class vrpn_Ohmmeter_ORPX2 : public nmb_Device_Server, public vrpn_Ohmmeter {
  public:
...
class vrpn_Ohmmeter_Server : public nmb_Device_Server, public vrpn_Ohmmeter {
  public:
    vrpn_Ohmmeter_Server(char *name, vrpn_Connection *c, vrpn_float32 hz=1.0);
    virtual void mainloop(void);
    virtual int register_change_handler(void *userdata,
                                vrpn_SETOHMCHANGEHANDLER handler);
    virtual int unregister_change_handler(void *userdata,
...
class vrpn_Ohmmeter_Remote : public nmb_Device_Client, public vrpn_Ohmmeter {
  public:
