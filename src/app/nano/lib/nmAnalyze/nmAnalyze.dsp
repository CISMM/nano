...
# ADD CPP /nologo /MDd /W3 /GX /Zi /Od /I "../../../../lib/nmBase" /I "..\..\..\..\..\..\vrpn" /I "." /I "..\..\..\..\..\..\quat" /I "..\..\..\..\..\..\vogl" /I "..\..\..\..\..\..\external\pc_win32\include" /I "..\..\..\..\lib\nmBase" /I "..\..\..\..\lib\ImgFormat" /I "..\nmUGraphics" /I "..\.." /I "..\nmMScope" /I "..\..\..\..\lib\nmMP" /I "..\..\..\..\lib\tcllinkvar" /I "..\nmUI" /D "_DEBUG" /D "_LIB" /D "USE_VRPN_MICROSCOPE" /D "V_GLUT" /D "NO_RAW_TERM" /D "NO_XWINDOWS" /D "NO_ITCL" /D "NO_FILTERS" /D "NO_EXT_TEXTURES" /D "PROJECTIVE_TEXTURE" /D "NDEBUG" /D "_MBCS" /D "VRPN_NO_STREAMS" /FR /YX /FD /I /GZ /TP /c
