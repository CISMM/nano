...
// for SgSetRetrace:
const int EDAX_DEFAULT_HORZ_RETRACE = 750;
const int EDAX_DEFAULT_VERT_RETRACE = 750;
...
const int EDAX_DEFAULT_X_DAC_OFFSET = ((EDAX_MAX_OFFSET + EDAX_MIN_OFFSET)/2);
const int EDAX_DEFAULT_Y_DAC_OFFSET = EDAX_DEFAULT_X_DAC_OFFSET;
const int EDAX_DEFAULT_Z_ADC_OFFSET = EDAX_DEFAULT_X_DAC_OFFSET;
...
// for SgSetMaxSpan:
const int EDAX_DEFAULT_MAX_X_SPAN =(65535);
const int EDAX_DEFAULT_MAX_Y_SPAN =(51200);
