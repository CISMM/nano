...
class	Point_channel_selector : public Channel_selector
{
    ...
    protected:
    Point_results * myresult;         ///< The latest measurements at a point. 
    Point_value * values [MAX_CHANNELS];    ///< Pointers into myresult list, for quick indexing
    Point_list * d_pointList;  ///< List of Point_results, for external use. 
};
