...
struct AFMModifyState {
  ...
  // step size not sent to microscope, and 
  // we need both to be TclNet vars so 
  // modify live step size is also shared
...
struct AFMState {
  ...
  TclNet_int autoscan;	///< Should the SPM start scanning after touch?
