...
nmg_ImageDisplayProjectiveTexture::nmg_ImageDisplayProjectiveTexture
   (nmg_Graphics *g):
  nmb_ImageDisplay(),
...
void nmg_ImageDisplayProjectiveTexture::addImageToDisplay(nmb_Image *image)
{
...
void nmg_ImageDisplayProjectiveTexture::removeImageFromDisplay(nmb_Image *
                                                            /*image*/)
{
  if (!d_graphicsDisplay) return;
...
void nmg_ImageDisplayProjectiveTexture::updateDisplayTransform(
                                       nmb_Image * /*image*/,
                                       double *transform)
{
  if (!d_graphicsDisplay) return;
...
void nmg_ImageDisplayProjectiveTexture::setDisplayColorMap(
                         nmb_Image * /*image*/,
...
void nmg_ImageDisplayProjectiveTexture::setDisplayColorMapRange(
                        nmb_Image * /*image*/,
