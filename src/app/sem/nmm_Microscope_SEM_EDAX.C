...
*/
  result = CloseColumn();
  printf("CloseColumn returned %d\n", result);

  // **************
  // stage controls
  // **************
  result = OpenStage();
  printf("OpenStage returned %d\n", result);
                                    ...
                                    (vrpn_int32 &enable) 
{
  ...
  d_external_scan_control_enabled = call_result;
#endif
...
#ifndef VIRTUAL_SEM
  LONG result = SpMove(x, y, obsolete_parameter);
