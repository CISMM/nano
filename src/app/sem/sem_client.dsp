...
!MESSAGE 
!MESSAGE "sem_client - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "sem_client - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../../../external/pc_win32/include" /I "../../../../vrpn" /I "../nano/lib/nmSEM" /I "../../lib/nmImageViewer" /I "../../lib/nmBase" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "V_GLUT" /YX /FD /TP /c
...
# ADD LINK32 opengl32.lib glut32.lib vrpn.lib wsock32.lib quat.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"../../../../external/pc_win32/lib" /libpath:"../../../../vrpn/pc_win32/debug" /libpath:"../../../../quat/pc_win32/debug"
