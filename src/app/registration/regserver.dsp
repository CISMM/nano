...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "..\..\..\..\vrpn" /I "..\..\lib\nmBase" /I "..\..\lib\nmMP" /I "..\..\lib\tcllinkvar" /I "..\..\..\..\external\pc_win32\include" /I "..\..\..\..\quat" /I "..\..\..\..\vogl" /I "..\nano\lib\nmReg" /I "..\..\lib\nmImageViewer" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "V_GLUT" /D "VRPN_NO_STREAMS" /YX /FD /TP /c
...
# ADD LINK32 vrpn.lib wsock32.lib opengl32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /machine:I386 /libpath:"..\..\..\..\external\pc_win32\lib" /libpath:"../../../../vrpn/pc_win32/Release"

!ELSEIF  "$(CFG)" == "regserver - Win32 Debug"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "regserver___Win32_Debug"
# PROP BASE Intermediate_Dir "regserver___Win32_Debug"
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\..\lib\nmMP" /I "..\..\..\..\vrpn" /I "..\..\lib\nmBase" /I "..\..\lib\tcllinkvar" /I "..\..\..\..\external\pc_win32\include" /I "..\..\..\..\quat" /I "..\..\..\..\vogl" /I "..\nano\lib\nmReg" /I "..\..\lib\nmImageViewer" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "V_GLUT" /D "VRPN_NO_STREAMS" /YX /FD /GZ /TP /c
