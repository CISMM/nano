...
iwidgets::messagedialog .error_dialog -title "NanoManipulator Error" \
    -bitmap info -text "Error"

.error_dialog hide Help
#.message_dialog buttonconfigure OK -text "Yes"
.error_dialog hide Cancel 
proc nano_error {msg {fatal 0} } {
    global term_input
    .error_dialog config -text "$msg"
    if {$fatal} {
        .error_dialog buttonconfigure OK -command "set term_input q"
    } else {
...
#    puts " mainwin $width $height $main_xpos $main_ypos [wm geometry .]"
    ...
    wm geometry $graphmod(sc) +[expr $main_xpos + $width + $winborder]+$main_ypos
